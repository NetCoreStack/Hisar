...
namespace NetCoreStack.Hisar.Tests
{
    ...
    public class HisarFixture<TStartup> : IDisposable
    {
        private const string SolutionName = "NetCoreStack.Hisar.sln";
        ...
        protected HisarFixture(string solutionRelativeTargetProjectParentDir)
        {
